...
static const struct tty_operations xr_usb_serial_ops = {
	...
	.write =		(ssize_t (*)(struct tty_struct *, const u8 *, size_t))xr_usb_serial_tty_write,
	.write_room =		(unsigned int (*)(struct tty_struct *))xr_usb_serial_tty_write_room,
	.ioctl =		xr_usb_serial_tty_ioctl,
	.throttle =		xr_usb_serial_tty_throttle,
	.unthrottle =		xr_usb_serial_tty_unthrottle,
	.chars_in_buffer =	(unsigned int (*)(struct tty_struct *))xr_usb_serial_tty_chars_in_buffer,
	.break_ctl =		xr_usb_serial_tty_break_ctl,
	.set_termios =		(void (*)(struct tty_struct *, const struct ktermios *))xr_usb_serial_tty_set_termios,
...
{
	int retval;
	xr_usb_serial_tty_driver = tty_alloc_driver(XR_USB_SERIAL_TTY_MINORS, TTY_DRIVER_REAL_RAW | TTY_DRIVER_DYNAMIC_DEV);
